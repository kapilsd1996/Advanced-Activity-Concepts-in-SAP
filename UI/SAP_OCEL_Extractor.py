...
dd07t = pd.read_csv('..bin\SAP_metadata_tables\DD07T.csv'  , encoding= 'unicode_escape' )
tstct = pd.read_csv('..bin\SAP_metadata_tables\TSTCT_E.csv', encoding= 'unicode_escape')
dd03t = pd.read_csv('..bin\SAP_metadata_tables\DD03T_E.csv', encoding= 'unicode_escape')
dd02v = pd.read_csv('..bin\SAP_metadata_tables\DD02V.csv', encoding= 'unicode_escape')
tcdob = pd.read_csv('..bin\SAP_metadata_tables\TCDOB.csv', encoding= 'unicode_escape')
tcdobt= pd.read_csv('..bin\SAP_metadata_tables\TCDOBT.csv', encoding= 'unicode_escape')
t003t = pd.read_csv('..bin\SAP_metadata_tables\T003T.csv', encoding= 'unicode_escape')
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Process tables and generate OCEL.")
    parser.add_argument("input_table_list", nargs="+", help="List of input tables")

    args = parser.parse_args()
    input_table_list = args.input_table_list
    import_dd03l(input_table_list)
